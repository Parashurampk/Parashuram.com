...
public class FlipKartHighAndLowPrice {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < iPhone_title.size(); i++) {
			...
			long price = parsePrice(priceText.replaceAll("[^0-9]", ""));
        ...
        System.out.println("Sorted Prices:");// Print sorted prices
	...
	private static long parsePrice(String priceText) {
		String cleanedPriceText = priceText.replaceAll("[^0-9]", ""); // Remove non-numeric characters and parse as a																	// long
		try {
